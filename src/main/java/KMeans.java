...
public class KMeans {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        do {
            centroids = readCentroids(/*fileSystem*/ null, args[0]);
            ...
            newCentroids = readCentroids(null, args[2] + "/part-r-00000");
            writeCentroids(null, newCentroids, args[0]);
            deleteOutputDirectory(null, args[2]);
    ...
    private static void writeCentroids
        ...
        // BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(out)); UNCOMMENT FOR HADOOP
